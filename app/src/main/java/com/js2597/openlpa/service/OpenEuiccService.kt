package com.js2597.openlpa.service
...
import com.js2597.openlpa.util.*

class OpenLPAService : EuiccService() {
    private val openlpaApplication
        get() = application as OpenLPAApplication

    private fun findChannel(slotId: Int): EuiccChannel? =
        openlpaApplication.euiccChannelManager
    ...
    override fun onSwitchToSubscription(
        ...
        try {
            ...
            openlpaApplication.euiccChannelManager.invalidate()
        }
    }
    ...
    override fun onUpdateSubscriptionNickname(slotId: Int, iccid: String, nickname: String?): Int {
        ...
        openlpaApplication.subscriptionManager.tryRefreshCachedEuiccInfo(channel.cardId)
        return if (success) {
            RESULT_OK
        } else {
            RESULT_FIRST_USER
